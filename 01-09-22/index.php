                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="action.php" method="POST">
                                ...
                                <input type="submit" name="addtocart" value="Add To Cart" class="btn btn-info">
                            </form>
                        </div>
                ...
                if (empty($_SESSION['mycart'])) {
                    ...
                    foreach ($_SESSION['mycart'] as $product) {
                        ...
                        while ($row = mysqli_fetch_array($query)) {
                            ...
                            echo '<tr>
                    <td><img src="img/' . $row['product_img'] . '" width="70px"/></td>
                    ...
                    <button class="btn btn-success" type="submit" name="updateaddtocart">Update</button>
                    </form>
                    <br>
                    <br>
                    <form action="action.php" method="POST">
                    <input type="hidden" value="' . $row['id'] . '" name="product_id">
                    <button class="btn btn-danger" type="submit" name="removeaddtocart">Remove</button>
                    </form>
